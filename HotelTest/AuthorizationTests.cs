...
public class CheckAuth
{
    ...
    {
        var actual = Authorization.CheckLogAndPass("admin1", "admin1", context);
    ...
    {
        var actual = Authorization.CheckLogAndPass("aDmin1_", "admin1", context);
        Assert.Equal("false", actual);
    }
    ...
    {
        var actual = Authorization.CheckLogAndPass("admin1", "admln1", context);
        Assert.Equal("false", actual);
    }
}
